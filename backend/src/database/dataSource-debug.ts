console.log('[DataSource] Starting dataSource initialization...');
import { DataSource } from 'typeorm';
import dotenv from 'dotenv';
import path from 'path';

console.log('[DataSource] Loading entities...');
...
console.log('[DataSource] Entities loaded');

// Load .env from backend directory
console.log('[DataSource] Loading environment from:', path.resolve(__dirname, '../../.env'));
dotenv.config({ path: path.resolve(__dirname, '../../.env') });

// Check environment
const isDevelopment = process.env.NODE_ENV === 'development' || !process.env.NODE_ENV;

console.log('[DataSource] Environment:', process.env.NODE_ENV || 'development (default)');
console.log('[DataSource] Database sync enabled:', isDevelopment);
...
console.log('[DataSource] DataSource instance created successfully');
console.log('[DataSource] Type of AppDataSource:', typeof AppDataSource);
console.log('[DataSource] Module loading complete');
