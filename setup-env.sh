...
# Bash script to create .env file for ConnectWise-Nable RMM Integration

echo -e "\033[32mCreating .env file for ConnectWise-Nable RMM Integration...\033[0m"
...
echo ""
echo -e "\033[33mIMPORTANT: Please update the following in your .env file:\033[0m"
echo -e "\033[33m1. ConnectWise API credentials (CONNECTWISE_*)\033[0m"
echo -e "\033[33m2. N-able RMM API credentials (NABLE_*)\033[0m"
echo -e "\033[33m3. SMTP settings for email notifications\033[0m"
echo -e "\033[33m4. Slack/Teams webhook URLs if using those integrations\033[0m"
echo -e "\033[33m5. Change JWT_SECRET to a secure random string\033[0m"
echo -e "\033[33m6. Change DB_PASSWORD for production use\033[0m"
echo ""
echo -e "\033[36mTo edit the file, run: nano .env or vim .env\033[0m"
